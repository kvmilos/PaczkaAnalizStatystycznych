...
# from ..biblioteka.dict import countries_dict
# from ..biblioteka.dane import lata_scal, przerob, oczysc, kraje, scal
# from ..biblioteka.analizy import max_co2_p_c, max_gdp_p_c, co2_change_p_c
import pytest
